...
const programs = [
  ...
  },
  {
    ...
    icon: <FaTools size={28} />,
     image: "/programs/think4impact.jpg",
    description:
  ...
  },
  {
    ...
    image: "/programs/dream-lead-impact.jpg",
    description:
...
>
  {/* Square Image */}
  <div className="w-full h-48 mb-4 overflow-hidden rounded-lg border-2 border-primary shadow">
    <img
      src={program.image}
      alt={program.title}
  ...
  <p className="text-sm text-zinc-600 dark:text-zinc-300 text-justify">
    {displayText}
    {shouldTruncate && (
      <span
